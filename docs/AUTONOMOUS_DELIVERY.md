...
Repository: `hillstreet-ph/open-system`  
...
Preserve existing release and Docker workflows; do not add a competing release engine.

## Docker contract

Existing Docker workflows are canonical; verify their documented variable and secret contract before promotion.
